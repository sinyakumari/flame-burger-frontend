...
/* ── Item Detail Drawer (sub-component) ──────── */
...
const AdminMenuPage = () => {
  ...
  const toggleAvailability = async (item) => {
    ...
    try {
      ...
      if (selectedItem?._id === item._id) {
        setSelectedItem(prev => ({ ...prev, isActive: newStatus }));
      }
    } catch (err) { console.error(err); }
  };
  ...
  const resetForm = () => {
    setEditingId(null);
    setName(""); setPrice(""); setDesc(""); setImg(""); setImageFile(null);
  };
                ...
                <div className="amp-card-body">
                  ...
                  <div className="amp-card-footer">
                    ...
                    <div className="amp-card-actions" onClick={e => e.stopPropagation()}>
                      ...
                      <button className="amp-btn-icon edit" title="Edit"
                        onClick={e => { e.stopPropagation(); startEdit(item); }}>✏️</button>
                      <button className="amp-btn-icon del" title="Delete"
                        onClick={e => { e.stopPropagation(); handleDelete(item._id); }}>🗑</button>
                    </div>
                  </div>
                </div>
              </div>
